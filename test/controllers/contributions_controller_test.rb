...
class ContributionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contribution" do
    assert_difference('Contribution.count') do
      post contributions_url, params: { contribution: { category: @contribution.category, overview: @contribution.overview, title: @contribution.title, update: @contribution.update, user_name: @contribution.user_name } }
    end
  ...
  test "should update contribution" do
    patch contribution_url(@contribution), params: { contribution: { category: @contribution.category, overview: @contribution.overview, title: @contribution.title, update: @contribution.update, user_name: @contribution.user_name } }
